...
export default function Index() {
    ...
    const handleExportExcel = () => {
        ...
        form.method = 'POST';
        form.action = route('owner.barang-keluar.export-excel');
            ...
            <div className="container mx-auto p-4">
                ...
                <div className="mb-6">
                    <h1 className="mb-2 text-2xl font-bold text-gray-900 dark:text-gray-100">
                        Cetak Laporan Bahan Keluar
                    </h1>
                    <p className="text-gray-600 dark:text-gray-400">
                        Pilih rentang tanggal untuk mencetak laporan bahan
                        keluar
                    </p>
                </div>
                    ...
                    {tanggalAwal && tanggalAkhir && (
                        <div className="mt-6 rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
                            ...
                            <p className="mt-1 text-sm text-blue-700 dark:text-blue-300">
                                Laporan akan menampilkan data bahan keluar dari
                                tanggal{' '}
                                <strong>
                            ...
                            <p className="mt-2 text-xs text-blue-600 dark:text-blue-400">
                                📄 Nama file: Laporan_Bahan_Keluar_
